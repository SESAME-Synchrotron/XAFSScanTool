...
/* Generated from ../O.Common/XAFS.dbd */
...
int XAFS_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/dcasu/Desktop/SESAME/Beamlines/XAFS/IOCs/XAFS_DAQ";
...
/* XAFS_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"XAFS_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    XAFS_registerRecordDeviceDriver(*iocshPpdbbase);
}
