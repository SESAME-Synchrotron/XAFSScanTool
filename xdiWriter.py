...
class XDIWriter: 
	...
	def createICKFXDIFile(self): # Create IC, Ketek and FICUS xdi file 
		...
		if not os.path.exists(self.fullFileName): 
			...
			f.write("# Column.6: mutrans (log(I0/Itrans))\n")
			f.write("# Column.7: murefer (log(Itrans/Irefer))\n")
			f.write("# Column.8: KETEK-Ifluor\n")
			f.write("# Column.9: KETEK-mufluor\n")
			f.write("# Column.10: KETEK-ROI_0[c/s]\n")
			f.write("# Column.11: KETEK-ROI_1[c/s]\n")
			f.write("# Column.12: KETEK-ROI_2[c/s]\n")
			f.write("# Column.13: KETEK-e-time[sec]\n")
			f.write("# Column.14: KETEK-DEADTIME[%]\n")
			f.write("# Column.15: KETEK-INT_TIME[sec]\n")
			f.write("# Column.16: KETEK-OCR\n")
			f.write("# Column.17: KETEK-ICR\n")
			f.write("# Column.18: FICUS-Ifluor\n")
			f.write("# Column.19: FICUS-mufluor\n")
			f.write("# Column.20: FICUS-ROI_0[c/s]\n")
			f.write("# Column.21: FICUS-ROI_1[c/s]\n")
			f.write("# Column.22: FICUS-ROI_2[c/s]\n")
			f.write("# Column.23: FICUS-e-time[sec]\n")
			f.write("# Column.24: FICUS-DEADTIME[%]\n")
			f.write("# Column.25: FICUS-INT_TIME[sec]\n")
	...
	def createICFXDIFile(self): 
		if not os.path.exists(self.fullFileName): 
			...
			f.write("# Column.6: mutrans (log(I0/Itrans))\n")
			f.write("# Column.7: murefer (log(Itrans/Irefer))\n")
			f.write("# Column.8: FICUS-Ifluor\n")
			f.write("# Column.9: FICUS-mufluor\n")
			f.write("# Column.10: FICUS-ROI_0[c/s]\n")
			f.write("# Column.11: FICUS-ROI_1[c/s]\n")
			f.write("# Column.12: FICUS-ROI_2[c/s]\n")
			f.write("# Column.13: FICUS-e-time[sec]\n")
			f.write("# Column.14: FICUS-DEADTIME[%]\n")
			f.write("# Column.15: FICUS-INT_TIME[sec]\n")
			if self.personalInfoFlage == 1:
				f.write("# Experiment.Type: Proposal\n")
				f.write("# Proposal.ID: {}\n".format(self.proposalID))
				f.write("# Proposal.title: {}\n".format(self.propTitle))
