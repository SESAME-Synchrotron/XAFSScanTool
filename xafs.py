...
class XAFSSCAN:
	...
	def drangeK(self,start,stop,step,prec=10):
		...
		try:
			...
			UIMessage.showCritical("sqrt of negative value!!", 
				"Energy range is less that the element foil energy!!",
				"Please rerun the DAQ and enter right parameters in the interval")
			sys.exit()
	...
	def start(self):
		...
		#CLIMessage("POINTSD ::: {}".format(points), "E")
		#CLIMessage("POINTSD ::: {}".format(dir(points)), "E")
		...
		if self.cfg["expType"] == "EnergyCalibration":
			...
			if i ==1: 
				...
				#x = energyCalibration('/root/XAFSScanTool.bck/DATA/Ti_EXAFS_NOC_-20211102T142119/{}'.format(file))
